    ...
    return (
        ...
        >
            <div className="container relative" ref={parallaxRef}>
                <div className="relative z-1 max-w-[62rem] mx-auto text-center mb-[4rem] md:mb-20 lg:mb-[62rem]]">
                    <h1 className="h1 mb-6 z-1 text-slate-400">
                        Explore the Possibilities of AI Chatting with
                        <span className="inline-block relative ml-2">Braiwave
                            <img src={curve}
                    ...
                    <p className="body-1 max-w-3xl mx-auto mb-6 text-n-2 lg:mb-8 z-1">
                ...
                <div className="relative max-w-[23rem] mx-auto md:max-w-5xl xl:mb-24">
                    ...
                    <div className="absolute z-0 -top-[54%] left-1/2 w-[234%] -translate-x-1/2 md:-top-[46%] md:w-[138%]
                    lg:-top-[104%]
                    ">
