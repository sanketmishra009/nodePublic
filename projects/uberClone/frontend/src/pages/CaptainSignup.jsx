...
const CaptainSignup = () => {
    ...
    return (
        <div className='bg-slate-800 h-screen w-screen flex flex-col items-center justify-end gap-y-[2rem]'>
            < Header captain="true" />
            <div className="flex h-20 w-70 bg-orange-400 items-center justify-center px-4">
                <h1 className='text-base font-semibold leading-8 text-[1.5rem] underline'>
                    Capitan Sign Up!
                </h1>
            </div>
